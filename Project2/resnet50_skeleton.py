...
class ResNet50_layer4(nn.Module):
    def __init__(self, num_classes= 10 ): # Hint : How many classes in Cifar-10 dataset?
        ...
        self.layer1 = nn.Sequential(
            #Padding: Sets the size of the edge with a value of 0 increasing across all boundaries (i.e., 0 increments a few times around the feature map).
            nn.Conv2d(stride=2, kernel_size=7, padding=3, in_channels=3, out_channels=64 ),
