from skeleton_code.datasets import Loader
import torchvision.transforms as transforms
import PIL.Image as PIL
from skeleton_code.modules_skeleton import *
from torch.utils.data import DataLoader
from torch.optim.lr_scheduler import StepLR
from resnet_encoder_unet_skeleton import *
from skeleton_code.UNet_skeleton import *
...
data_dir = "Q:/Code/Project3/VOCdevkit/VOC2012"
resize_size = 256
...
# module_path = 'Q:/Code/Project3/trained_model/resnet_encoder_unet.pth'
model = UNetWithResnet50Encoder()
model_path = 'Q:/Code/Project3/trained_model/resnet_encoder_unet.pth'
...
result_save_dir = 'Q:/Code/Project3/skeleton_code/history/result'+date+'/'
...
savepath1 = "Q:/Code/Project3/skeleton_code/output/model" + date + '/'
...
for epoch in range(epochs):
    ...
    if epoch % 4 == 0:
        ...
        # torch.save(model.state_dict(), 'G:/Code/Project3/trained_model/My_Unet.pth')
        torch.save(model.state_dict(), 'G:/Code/Project3/trained_model/My_Resnet.pth')
